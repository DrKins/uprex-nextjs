    ...
    return (
        <div>
            ...
            <div className={styles.CardContainer}>
                <div><svg width="150" height="221" viewBox="0 0 150 221" fill="none" xmlns="http://www.w3.org/2000/svg">
